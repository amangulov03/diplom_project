...
const BreedingStock = () => {
    ...
    const secondaryFields = [
        ...
        {
            name: "живаяМассаПриПервомОсоменении",
            label: "Живая масса при первом осеменении, кг",
            type: "number",
        },
        {
            name: "возрастПервогоОсеменения",
            label: "Возраст первого осеменения, мес.",
            type: "text",
        },
        { name: "датаОсеменения", label: "Дата осеменения (1-20)", type: "text" },
        { name: "номерОсеменения", label: "Номер осеменения (1-20)", type: "text" },
        {
            name: "индивидуальныйНомерБыка",
            label: "Индивидуальный номер быка-осеменителя (1-20)",
            type: "text",
        },
        { name: "кличкаБыка", label: "Кличка быка-осеменителя (1-20)", type: "text" },
        { name: "методСлучки", label: "Метод случки (1-20)", type: "text" },
        {
            name: "датаИсследованияНаСтельность",
            label: "Дата исследования на стельность (1-20)",
            type: "text",
        },
        {
            name: "результатИсследованияНаСтельность",
            label: "Результат исследования на стельность (1-20)",
            type: "text",
        },
        ...
        {
            name: "индивидуальныеНомераПриплода",
            label: "Индивидуальный номер приплода (один ко многим) (1-20)",
            type: "text",
        },
        { name: "датаЗапуска", label: "Дата запуска (1-20)", type: "date" },
        {
            name: "продолжительностьСервисПериода",
            label: "Продолжительность сервис-периода, дней (1-20)",
            type: "text",
        },
        {
            name: "продолжительностьСухостойногоПериода",
            label: "Продолжительность сухостойного периода, дней (1-20)",
            type: "text",
        },
        {
            name: "датаКонтрольногоДоения",
            label: "Дата контрольного доения",
            type: "date",
        },
        ...
        {
            name: "белок",
            label: "Результат контрольного доения - белок, %",
            type: "text",
        },
        { name: "времяДоения", label: "Время доения, мин.", type: "text" },
        {
            name: "скоростьМолокоотдачи",
            label: "Скорость молокоотдачи, кг/мин.",
            type: "text",
        },
        {
            name: "баллСкоростиМолокоотдачи",
            label: "Балл за скорость молокоотдачи",
            type: "text",
        },
    ...
    const linearBFields = [
        ...
        {
            name: "номерОтца",
            label: "индивидуальный номер отца",
            type: "number",
            noValue: true,
        },
        { name: "рост", label: "рост (от 1-9)", type: "number", noValue: true },
        {
            name: "глубинаТуловища",
            label: "глубина туловища (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "ширинаГруди",
            label: "ширина груди (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "молочныйТип",
            label: "молочный тип (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "положениеТаза",
            label: "положение таза (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "ширинаТаза",
            label: "ширина таза (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "постановкаЗаднихНогСбоку",
            label: "постановка задних ног (вид сбоку) (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "уголКопыт",
            label: "угол копыт (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "постановкаЗаднихНогСзади",
            label: "постановка задних ног (вид сзади) (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "качествоКостяка",
            label: "качество костяка (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "прикреплениеПереднихДолей",
            label: "прикрепление передних долей вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "глубинаВымени",
            label: "глубина вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "высотаПрикрепленияЗаднихДолей",
            label: "высота прикрепления задних долей вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "центральнаяСвязка",
            label: "центральная связка вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "расположениеПереднихСосков",
            label: "расположение передних сосков вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "расположениеЗаднихСосков",
            label: "расположение задних сосков вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "длинаСосков",
            label: "длина сосков (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "длинаКрестца",
            label: "длина крестца (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "линияВерха",
            label: "линия верха (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "обмускуленность",
            label: "обмускуленность (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "упитанность",
            label: "упитанность (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "скакательныйСустав",
            label: "скакательный сустав (вид сзади) (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "легкостьДвижения",
            label: "легкость движения (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "ширинаЗаднихДолей",
            label: "ширина задних долей вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "балансВымени",
            label: "баланс вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "выраженностьВен",
            label: "выраженность вен вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "длинаПереднихДолей",
            label: "длина передних долей вымени (от 1-9)",
            type: "number",
            noValue: true,
        },
        {
            name: "толщинаСосков",
            label: "толщина сосков (от 1-9)",
            type: "number",
            noValue: true,
        },
    ];
    ...
    const linearAFields = [
        {
            name: "молочныйТип",
            label: "молочный тип (от 50-100)",
            type: "number",
            noValue: true,
        },
        {
            name: "объемТуловища",
            label: "объем туловища (от 50-100)",
            type: "number",
            noValue: true,
        },
        {
            name: "конечности",
            label: "конечности (от 50-100)",
            type: "number",
            noValue: true,
        },
        ...
        {
            name: "итоговаяОценка",
            label: "итоговая оценка (от 1-100)",
            type: "number",
            noValue: true,
        },
        {
            name: "экстерьерПоБонитировке",
            label: "экстерьер по бонитировке",
            type: "text",
            noValue: true,
        },
    ];
    ...
    const linearABooleanFields = [
        ...
        "перехватЗаЛопатками",
        "неровнаяЛинияВерха",
        "высокаяПостановкаХвоста",
        "запавшийКореньХвоста",
        "крышевидныйКрестец",
        "шилозадость",
        "разметПереднихНог",
        "мягкиеБабки",
        ...
        "наклонноеДноВымени",
        "допСоски",
        "неправильнаяФормаСосков",
        "тонкиеСоски",
        "перекрестныеЗадниеСоски",
        "атрофияДолейВымени",
    ];
    ...
    return (
        <div className="breeding-stock-container">
            ...
            <div className="linear-system">
                ...
                <form>
                    {linearBFields.map((field) => renderInput(field, "линейнаяОценкаБ"))}
                </form>
            </div>
            <div className="linear-system">
