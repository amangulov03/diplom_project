...
function BullsForeing() {
  const [formData, setFormData] = useState({
      ...
      const mainFields = [
          ...
          { name: "кличка", label: "Кличка", type: "text" },
          { name: "компания_поставщикСемени", label: "Компания - поставщик семени", type: "text" },
      ...
      return (
          <div className="breeding-stock-container">
              <RightMenu
                  ...
                  dataType="bullsForeing"
              />
              <div className="text_title">
                  <h1>Быки (иностранные)</h1>
              </div>
